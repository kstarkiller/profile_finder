...
""")
    ...
    def test_create_month_column(self, mock_get_encoding, mock_exists):
        ...
        # Vérifier que la colonne 'Mois' est correctement créée
        expected_months = ["January 2021, February 2021, March 2021", "February 2021"]
        self.assertListEqual(df["Mois"].tolist(), expected_months)
