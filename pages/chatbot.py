...
# Contexte du chatbot
starting_content = f"""You are a french chatbot assistant that helps users to find members of a team based on their skills, names, experiences or availability.
...
def display_accueil():
    ...
    if "chat_history" not in st.session_state:
        st.session_state["chat_history"] = [{"role": "system", "content": starting_content}]
    ...
    st.chat_input(placeholder="Posez votre question...", key="temp_input", on_submit=update_input)
